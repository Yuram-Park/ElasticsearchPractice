 ...
 * 
 */
@Document(indexName="chosung")
@Getter
@Setter
@Builder
@AllArgsConstructor
@RequiredArgsConstructor
@Setting(replicas = 0, settingPath = "/elasticsearchChosung/settings.json")
@Mapping(mappingPath = "/elasticsearchChosung/mappings.json")
public class ChosungDocument {
	...
	public static ChosungDocument save(Breed breed) {
		return ChosungDocument.builder()
